...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Object>> handleAuctionNotFoundException(AuctionNotFoundException ex) {
    ...
    public ResponseEntity<ApiResponse<Object>> handleInvalidBidException(InvalidBidException ex) {
        ApiResponse<Object> response = ApiResponse.error(ex.getMessage());
